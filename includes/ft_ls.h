...
/*   Updated: 2019/03/27 15:13:54 by gedemais         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
** ft_params.c
*/
char			*ft_relaunch_condition(t_file *lst, char *params, char *name,
					int mask);
int				ft_params_relaunch(t_file *lst, char **params, char *path,
					int mask);
